...
with fg.as_default():
	...
	w_1 = tf.Variable(tf.truncated_normal([5, 5, 3, 10], stddev = 0.1))
	b_1 = tf.Variable(tf.zeros([10]))
	w_2 = tf.Variable(tf.truncated_normal([5, 5, 10, 15], stddev = 0.1))
	b_2 = tf.Variable(tf.constant(1.0, shape = [15]))
	w_25 = tf.Variable(tf.truncated_normal([5, 5, 15, 80], stddev = 0.1))
	b_25 = tf.Variable(tf.constant(1.0, shape = [80]))
	w_3 = tf.Variable(tf.truncated_normal([32//4*32//16*5, 128], stddev = 0.1))
	b_3 = tf.Variable(tf.constant(1.0, shape = [128]))
	w_4 = tf.Variable(tf.truncated_normal([128, 10], stddev = 0.1))
	b_4 = tf.Variable(tf.constant(1.0, shape = [10]))
	def cnn(data):
